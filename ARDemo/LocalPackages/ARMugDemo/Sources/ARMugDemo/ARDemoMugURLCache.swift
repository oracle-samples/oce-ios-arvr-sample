...
public class ARDemoMugURLCache: ObservableObject, Codable, URLCacheProtocol {
    
    public static var instance: URLCacheProtocol = ARDemoMugURLCache()
    
    public static var fileLocation = FileManager.default
        .urls(for: .documentDirectory, in: .userDomainMask)[0]
        .appendingPathComponent("ARDemoMugURLCache.json")
